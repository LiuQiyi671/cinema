<template>
    <div>
        ...
        >
            ...
            <div class="top">
                <el-col>
                    <el-button type="primary" size="small" @click="addHotMovie">添加即将上映影片</el-button>
                </el-col>
            </div>
                ...
                <el-table border stripe :data="upcomingmovieList">
                    ...
                    <el-table-column label="操作" width="200" align="center">
                        <template slot-scope="scope" v-if="scope.row">
                            ...
                            <el-button size="mini" type="danger" @click="deleteOneUpcomingMovie(scope.row.movieid)">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
